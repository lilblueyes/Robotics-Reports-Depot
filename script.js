...
const FILE_UPLOAD_CONTAINER = document.getElementById("file-upload-container");
const FILE_NAME_DISPLAY = document.getElementById("file-name-display");

FILE_UPLOAD_CONTAINER.addEventListener("click", () => {
  FILE_INPUT.click();
});
...
UPLOAD_BUTTON.addEventListener("click", () => {
  ...
  if (file) {
    ...
    alert("Sélectionne un fichier PDF avant d'essayer d'envoyer !");
  }
});
...
CANCEL_BUTTON.addEventListener("click", () => {
  ...
  FILE_UPLOAD_CONTAINER.style.borderColor = "#fff";
});
...
FILE_UPLOAD_CONTAINER.addEventListener("dragover", (event) => {
  event.preventDefault();
  FILE_UPLOAD_CONTAINER.classList.add("dragover");
});

FILE_UPLOAD_CONTAINER.addEventListener("dragleave", () => {
  FILE_UPLOAD_CONTAINER.classList.remove("dragover");
});
